...
const wikiEntries = [
    ...
    },
    {
        ...
        content: 'Mobilidade Circulares BUSP 8082-10 8083-10 8084-10 8085-10 fins semana madrugadas 8012-10 8022-10 cartão BUSP obrigatório gratuidade tarifa cobrada Bilhete Único Guia Bandejão Física mais próximo Central mais preferido Prefeitura melhor avaliado recarregar créditos RU Card aplicativo Cardápio USP PIX PAPFE sistema carrega créditos automaticamente Esporte Lazer CEPEUSP CEPE piscinas quadras academia gratuitas exame médico carteirinha USP digital liberar estresse provas Burocracia Infraestrutura Seção de Alunos trancamentos matrículas Pró-Aluno lanhouse instituto PCs computadores relatórios experimentos imprimir listas pesquisas PROFIS apoio pesquisa professores física recursos didáticos projetos ensino docentes licenciatura Networking Acadêmico Professores pesquisadores Iniciação Científica proatividade email formal sala conversar',
    },
    {
