                ...
                <div className="lg:col-span-7 space-y-6">
                    <form onSubmit={handleSend} className="bg-neutral-900/50 border border-white/5 rounded-[32px] p-8 space-y-6 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 bg-brand-blue hover:bg-brand-blue disabled:opacity-50 disabled:cursor-not-allowed text-white font-black uppercase tracking-widest rounded-[20px] shadow-xl shadow-brand-blue/20 transition-all flex items-center justify-center gap-3 active:scale-95 group"
                        >
                            {isLoading ? (
