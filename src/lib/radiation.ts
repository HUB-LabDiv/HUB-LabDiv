...
export const RADIATION_TIERS: RadiationTier[] = [
    ...
    { id: 'aco', name: 'Aço', level: 15, xpMin: 2400, color: 'text-brand-blue', bgColor: 'bg-brand-blue', borderColor: 'border-brand-blue', hex: '#3B82F6', emoji: '🔷' },
    { id: 'aco_i', name: 'Aço I', level: 16, xpMin: 2720, color: 'text-brand-blue', bgColor: 'bg-brand-blue', borderColor: 'border-brand-blue', hex: '#60A5FA', emoji: '🔷' },
