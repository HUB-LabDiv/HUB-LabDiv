        ...
        <div className="flex flex-col gap-4 w-full">
            {!modelUrl ? (
                <div className="w-full min-h-[16rem] border-2 border-dashed border-brand-yellow/30 rounded-xl flex flex-col items-center justify-center text-gray-300 transition-colors bg-brand-yellow/5 p-6">
                    ...
                    <span className="text-sm font-medium mb-4">Adicione um Modelo 3D (.glb, .gltf ou Link)</span>
                ...
                <div className="flex flex-col gap-3 w-full">
                    ...
                    {/* Exibição da legenda se não estiver ativo */}
                    {caption && !isActive && (
            ...
            {/* Painel Padronizado de Acessibilidade e Legenda para o Modelo 3D */}
            <BlockAccessibilityFields
                ...
                captionLabel="Legenda / Descrição do Modelo 3D"
                captionPlaceholder="Ex: Visualização tridimensional da molécula de cafeína / Estrutura do acelerador..."
                altTextLabel="Texto Alternativo (Acessibilidade / Audiodescrição)"
                altTextPlaceholder="Descreva a geometria, cores e detalhes do modelo 3D para pessoas com deficiência visual..."
                isActive={isActive}
            />
        </div>
    );
